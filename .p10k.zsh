# Generated by Powerlevel10k configuration wizard on 2020-01-17 at 13:33 CET.
...
() {
  ...
  typeset -g POWERLEVEL9K_CUSTOM_CURSOR="echo $"
  ...
  # When set to true, disables the right side prompt
  ...
  typeset -g POWERLEVEL9K_VCS_STAGED_ICON='\uF918'
  ...
  POWERLEVEL9K_VCS_STASHES_ICON=${(g::)POWERLEVEL9K_VCS_STASHES_ICON}
  typeset -g POWERLEVEL9K_VCS_CONFLICTED_ICON='\uFC23'
