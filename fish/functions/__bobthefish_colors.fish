function __bobthefish_colors -S -a color_scheme -d 'Define colors used by bobthefish'
  switch "$color_scheme"
    ...
    case 'nord'
      set -l black  2E3440
      set -l light_black  3B4252
      set -l dark_grey  434C5E
      set -l light_grey  4C566A
      set -l white  D8DEE9
      set -l base05  E5E9F0
      set -l base06  ECEFF4
      set -l base07  8FBCBB
      set -l light_blue  88C0D0
      set -l grey_blue  81A1C1
      set -l dark_blue  5E81AC
      set -l red  BF616A
      set -l orange  D08770
      set -l yellow  EBCB8B
      set -l green  A3BE8C
      ...
      set -x color_initial_segment_exit     $base05 $red --bold
      set -x color_initial_segment_private  $base05 $dark_grey
      set -x color_initial_segment_su       $base05 $green --bold
      set -x color_initial_segment_jobs     $base05 $orange --bold

      set -x color_path                     $dark_grey $base05
      set -x color_path_basename            $dark_grey $base06 --bold
      set -x color_path_nowrite             $dark_grey $light_blue
      set -x color_path_nowrite_basename    $dark_grey $light_blue --bold

      set -x color_repo                     $green $colorfg
      set -x color_repo_work_tree           $dark_grey $colorfg --bold
      set -x color_repo_dirty               $red $colorfg
      set -x color_repo_staged              $yellow $colorfg

      set -x color_vi_mode_default          $light_blue $colorfg --bold
      set -x color_vi_mode_insert           $green $colorfg --bold
      set -x color_vi_mode_visual           $purple $colorfg --bold

      set -x color_vagrant                  $dark_grey $colorfg --bold
      set -x color_k8s                      $dark_grey $colorfg --bold
      set -x color_aws_vault                $dark_blue $yellow --bold
      set -x color_aws_vault_expired        $dark_blue $red --bold
      set -x color_username                 $dark_grey $yellow --bold
      set -x color_hostname                 $dark_grey $yellow
      set -x color_rvm                      $grey_blue $colorfg --bold
      set -x color_node                     $grey_blue $colorfg --bold
      set -x color_virtualfish              $grey_blue $colorfg --bold
      set -x color_virtualgo                $grey_blue $colorfg --bold
      set -x color_desk                     $grey_blue $colorfg --bold
